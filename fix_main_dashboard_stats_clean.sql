-- ==============================================================================
-- FIX: MAIN DASHBOARD STATS - VERSION FINAL LIMPIA
-- FECHA: 20/02/2026
-- CAMBIO: Lógica de prioridad corregida (Supervisor > Jefe) aplicada a la función correcta.
-- Se ha eliminado el hardcode de usuario específico para que funcione con todos.
-- ==============================================================================

DROP FUNCTION IF EXISTS public.get_main_dashboard_stats(text, text);
...
BEGIN
    ...
    RETURN json_build_object(
        ...
        'debug_info', json_build_object(
            ...
            'function_name', 'get_main_dashboard_stats_CLEAN'
        )
    );
END;
$$;
