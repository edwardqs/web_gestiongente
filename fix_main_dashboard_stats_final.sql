-- ==============================================================================
-- FIX: MAIN DASHBOARD STATS - LOGICA EXPLICITA CON OVERRIDE PARA ASOLANO
-- FECHA: 20/02/2026
-- CAMBIO: Aplicar la corrección a la función CORRECTA (get_main_dashboard_stats)
-- que es la que llama el Frontend.
-- ==============================================================================
...
BEGIN
    ...
    RETURN json_build_object(
        ...
        'debug_info', json_build_object(
            ...
            'function_name', 'get_main_dashboard_stats'
        )
    );
END;
$$;
